...
module "markitos_backend" {
  ...
  backend_s3_bucket_key     = "markitos_terramods/terraform/states"
  backend_s3_bucket_id      = "markitos_terramods.terraform.state"
  backend_dynamodb_table    = "markitos_terramods-main-terraform-lock"
}
